...
class MetricBolt:
    ...
    def bolt(self):
        ...
        fusion.ViewObject.ShapeColor=getattr(self.cap.getLinkedObject(True).ViewObject,'ShapeColor',fusion.ViewObject.ShapeColor)
        fusion.ViewObject.DisplayMode=getattr(self.cap.getLinkedObject(True).ViewObject,'DisplayMode',fusion.ViewObject.DisplayMode)
